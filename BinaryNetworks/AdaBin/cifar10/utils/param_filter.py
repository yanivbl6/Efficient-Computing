...
def is_bn(module):
    ##if "lp_norm" in str(module.__class__) :
    # print(module.__class__)
    # print("MBN" in str(module.__class__))
    return isinstance(module, nn.modules.batchnorm._BatchNorm) or "MBN" in str(module.__class__) 
